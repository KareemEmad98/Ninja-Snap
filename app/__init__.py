...
def setup_logging(app):
    ...
    file_handler = RotatingFileHandler(os.path.join(Config.LOGGING_DIR, Config.LOG_FILE_NAME), maxBytes=10000,
                                       backupCount=10)
    ...
    api_file_handler = RotatingFileHandler(
        os.path.join(Config.LOGGING_DIR, Config.API_LOG_FILE_NAME), maxBytes=10000, backupCount=10)
    ...
    db_file_handler = RotatingFileHandler(
        os.path.join(Config.LOGGING_DIR, Config.DB_LOG_FILE_NAME), maxBytes=10000, backupCount=10)
